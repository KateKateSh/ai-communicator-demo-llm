...
def query_huggingface(event, model="HuggingFaceH4/zephyr-7b-beta"):
    prompt = f"""
Ты — AI-коммуникатор спроса для логистики и e-commerce. Твоя задача — на основе входного события сформулировать строго структурированный ответ: прогноз спроса, 3–4 действия, роли и причину.

⚠️ Запрещено:
- выходить за формат
- сочинять художественные тексты
- повторять инструкцию или примеры
